...
public class SimpleSimulatedDataSocket extends DatagramSocket {
    ...
    public SimpleSimulatedDataSocket(int port, double lossRate, int averageDelay) throws SocketException, IllegalArgumentException {
        super(port);
        random = new Random();
    ...
    public SimpleSimulatedDataSocket(double lossRate, int averageDelay) throws SocketException, IllegalArgumentException {
        random = new Random();
    ...
    private class OutgoingDatagramPacket implements Runnable {
        ...
        public void run() {
            try {
                ...
                Thread.sleep(time);
                SimpleSimulatedDataSocket.super.send(packet);
