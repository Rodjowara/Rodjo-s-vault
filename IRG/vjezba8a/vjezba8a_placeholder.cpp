...
int main(int argc, char* argv[])
{
    ...
    std::string resPath("C:/Users/ivrod/Documents/irg/irglab/build/irgLab/vjezba8a");
    ...
    light.setPosition(glm::vec3(100, 20, 20));

    material.ka = glm::vec3(0.2f);
    material.kd = glm::vec3(0.2f, 0.1f, 0.8f);
    ...
    if (scene->HasMeshes()) {
        ...
        std::string vPath = resPath + "\\flat.vert";
        std::string fPath = resPath + "\\flat.frag";
        std::string gPath = resPath + "\\flat.geom";

        Shader* shader = new Shader(vPath.c_str(), fPath.c_str(), gPath.c_str());
